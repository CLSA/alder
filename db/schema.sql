...
-- -----------------------------------------------------
-- Table `alder`.`apex_analysis_has_apex_code`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`apex_analysis_has_apex_code` (
...
-- -----------------------------------------------------
-- Table `alder`.`apex_code`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`apex_code` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `alder`.`apex_host_has_image`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`apex_host_has_image` (
...
BEGIN
  ...
  FROM (
    SELECT code.value
    FROM analysis_has_code
    JOIN code ON code.code_id = code.id
    JOIN code_group ON code.code_group_id = code_group.id
    WHERE analysis_has_code.analysis_id = proc_analysis_id
  ) AS temp;
