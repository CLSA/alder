...
-- Table `alder`.`arrow`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`arrow` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- Table `alder`.`ellipse`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`ellipse` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `review_id` INT(10) UNSIGNED NOT NULL,
...
DELIMITER $$
USE `alder`$$
CREATE PROCEDURE `calculate_rating` (IN proc_review_id INT(10) UNSIGNED)
BEGIN
  SELECT SUM(value) INTO @rating
  FROM (
