...
-- Schema alder
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `alder` ;
USE `cenozo` ;
...
-- -----------------------------------------------------
-- Table `cenozo`.`log_entry`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cenozo`.`log_entry` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `application_id` INT(10) UNSIGNED NOT NULL,
  `datetime` DATETIME NOT NULL,
...
-- Table `alder`.`access`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`access` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `user_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `alder`.`analysis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`analysis` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `alder`.`analysis_has_code`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`analysis_has_code` (
...
-- -----------------------------------------------------
-- Table `alder`.`analysis_selection`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`analysis_selection` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `analysis_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `alder`.`annotation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`annotation` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `analysis_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `alder`.`apex_analysis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`apex_analysis` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `alder`.`apex_analysis_has_code`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`apex_analysis_has_code` (
...
-- -----------------------------------------------------
-- Table `alder`.`apex_analysis_selection`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`apex_analysis_selection` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `apex_analysis_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `alder`.`apex_host`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`apex_host` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `user_id` INT(10) UNSIGNED NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `alder`.`apex_review`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`apex_review` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `alder`.`apex_review_effective_apex_analysis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`apex_review_effective_apex_analysis` (
  `apex_review_id` INT(10) UNSIGNED NOT NULL,
  `apex_analysis_id` INT(10) UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `alder`.`apex_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`apex_user` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `user_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `alder`.`code_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`code_group` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `alder`.`custom_report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`custom_report` (
...
-- -----------------------------------------------------
-- Table `alder`.`exam_effective_apex_review`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`exam_effective_apex_review` (
  `exam_id` INT(10) UNSIGNED NOT NULL,
...
-- Table `alder`.`review`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`review` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `exam_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `alder`.`role_has_custom_report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`role_has_custom_report` (
  `role_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `alder`.`role_has_service`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`role_has_service` (
  `role_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `alder`.`scan_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`scan_type` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `alder`.`selection`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`selection` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `scan_type_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `alder`.`selection_option`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`selection_option` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `selection_id` INT(10) UNSIGNED NOT NULL,
...
-- Table `alder`.`service`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`service` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- Table `alder`.`setting`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`setting` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `site_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `alder`.`user_has_modality`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`user_has_modality` (
  `user_id` INT(10) UNSIGNED NOT NULL,
  `modality_id` INT(10) UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `alder`.`writelog`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `alder`.`writelog` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` INT(10) UNSIGNED NOT NULL,
  `site_id` INT(10) UNSIGNED NOT NULL,
  `role_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- procedure update_apex_review_effective_apex_analysis
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- procedure update_exam_effective_apex_review
-- -----------------------------------------------------
...
DELIMITER $$
USE `alder`$$
CREATE DEFINER = CURRENT_USER TRIGGER `alder`.`analysis_has_code_AFTER_INSERT` AFTER INSERT ON `analysis_has_code` FOR EACH ROW
BEGIN
  CALL calculate_rating(NEW.analysis_id);
END$$

USE `alder`$$
CREATE DEFINER = CURRENT_USER TRIGGER `alder`.`analysis_has_code_AFTER_DELETE` AFTER DELETE ON `analysis_has_code` FOR EACH ROW
BEGIN
  CALL calculate_rating(OLD.analysis_id);
END$$

USE `alder`$$
CREATE DEFINER = CURRENT_USER TRIGGER `alder`.`apex_analysis_AFTER_INSERT` AFTER INSERT ON `apex_analysis` FOR EACH ROW
BEGIN
  CALL update_apex_review_effective_apex_analysis(NEW.apex_review_id);
END$$

USE `alder`$$
CREATE DEFINER = CURRENT_USER TRIGGER `alder`.`apex_analysis_AFTER_UPDATE` AFTER UPDATE ON `apex_analysis` FOR EACH ROW
BEGIN
  CALL update_apex_review_effective_apex_analysis(NEW.apex_review_id);
END$$

USE `alder`$$
CREATE DEFINER = CURRENT_USER TRIGGER `alder`.`apex_analysis_AFTER_DELETE` AFTER DELETE ON `apex_analysis` FOR EACH ROW
BEGIN
  CALL update_apex_review_effective_apex_analysis(OLD.apex_review_id);
END$$

USE `alder`$$
CREATE DEFINER = CURRENT_USER TRIGGER `alder`.`apex_review_AFTER_INSERT` AFTER INSERT ON `apex_review` FOR EACH ROW
BEGIN
...
USE `alder`$$
CREATE DEFINER = CURRENT_USER TRIGGER `alder`.`apex_review_AFTER_UPDATE` AFTER UPDATE ON `apex_review` FOR EACH ROW
BEGIN
  CALL update_exam_effective_apex_review(NEW.exam_id);
END$$

USE `alder`$$
CREATE DEFINER = CURRENT_USER TRIGGER `alder`.`apex_review_AFTER_DELETE` AFTER DELETE ON `apex_review` FOR EACH ROW
BEGIN
  CALL update_exam_effective_apex_review(OLD.exam_id);
END$$

USE `alder`$$
CREATE DEFINER = CURRENT_USER TRIGGER `alder`.`review_AFTER_INSERT` AFTER INSERT ON `review` FOR EACH ROW
BEGIN
