...
namespace alder\service\apex_analysis\apex_analysis_selection;
...
class query extends \cenozo\service\query
{
  ...
  protected function setup()
  {
    ...
    {
      // cache the full list of selections (selected or not) for this apex_analysis
  ...
  /**
   * A cache of all possible selections for this apex_analysis
   * @var array(array)
   * @access private
   */
