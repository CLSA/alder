 ...
 */
define( 'ARGUMENT_ALDER_BASE_ERRNO',   150000 );
define( 'DATABASE_ALDER_BASE_ERRNO',   250000 );
define( 'LDAP_ALDER_BASE_ERRNO',       350000 );
define( 'NOTICE_ALDER_BASE_ERRNO',     450000 );
define( 'PERMISSION_ALDER_BASE_ERRNO', 550000 );
define( 'RUNTIME_ALDER_BASE_ERRNO',    650000 );
define( 'SYSTEM_ALDER_BASE_ERRNO',     750000 );
